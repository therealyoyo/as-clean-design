...
export const serviceContents: ServiceContent[] = [
  ...
  },
  {
    ...
    intro: "L'état des lieux sortant est le moment de vérité entre locataire et propriétaire. Un logement mal nettoyé peut coûter plusieurs centaines d'euros sur votre caution. Nos équipes réalisent un nettoyage de fin de bail complet et conforme aux standards attendus lors d'un état des lieux professionnel à Bruxelles.",
    inclusions: [
    ...
    faq: [
      { question: "Le nettoyage fin de bail garantit-il la récupération de ma caution ?", answer: "Un nettoyage professionnel conforme aux standards attendus maximise significativement vos chances. Cependant, la caution peut aussi couvrir des dommages autres que la propreté — nous ne pouvons garantir que la qualité du nettoyage, pas les décisions du propriétaire." },
